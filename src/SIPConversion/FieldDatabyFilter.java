...
public class FieldDatabyFilter {
	...
	String handle = "", source_root = "", logFilePath = "",
			fieldName="", expression = "", runType = "", lftokenizer = "",rttokenizer = "",ic="";
	...
	public FieldDatabyFilter(String runType) {
		...
		try {
			if(runType.equalsIgnoreCase("-l")) {
				System.out.println("th"+listPath);
	...
	public static void main (String[] args) throws Exception{
		...
		if(args.length<2) 
			System.out.println("Wrong Input Argument. Command Syntax : java -jar FieldDatabyFilter.jar -l[ist]/e[xpression] <ConfigFilePath>");
		...
		try {
			...
			System.out.println("You are using list match but you does not provide listPath in property file");
			System.out.println("Please uncomment the  list path from or provide a valid file path");
			System.exit(1);
