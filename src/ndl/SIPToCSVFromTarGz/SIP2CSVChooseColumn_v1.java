...
public class SIP2CSVChooseColumn_v1 {
	...
	private static String outputPath = "/home/ndl/Desktop/JavaDataCSV/Test/choosen/";
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length == 2) {
			...
			CSVReader headerCSV = new CSVReader(new FileReader(new File(configPath)));
...
//						System.out.println("data "+dataMap);
	...
	private static void multiplexmltocsv(String outputPath, int count) {
		// TODO Auto-generated method stub
//		System.out.println("out put path :"+outputPath);
...
//				System.out.println(i + "==>" + subheader[i]);
	...
	private static void parseDublin(String fileContentString) {
		// TODO Auto-generated method stub
		try {
