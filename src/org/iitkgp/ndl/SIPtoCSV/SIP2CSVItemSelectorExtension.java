...
public class SIP2CSVItemSelectorExtension {
	...
	public SIP2CSVItemSelectorExtension(String handleListPath, String sourcePath, String columnListPath,
			String destPath, Integer thresholdvalue) throws Exception {
